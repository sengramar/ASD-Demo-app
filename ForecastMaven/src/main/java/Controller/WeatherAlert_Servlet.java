...
//        }
        ...
        session.setAttribute("City", Region);
        ...
        */
        ...
        else if(Double.parseDouble(WindSpeed) > 10.8 && Double.parseDouble(WindSpeed) < 13.8) {
        ...
        if (Description.equals("light rain") || Description.equals("light intensity shower rain") ) {
            session.setAttribute("Warning", "It's drizzling.");
            request.getRequestDispatcher("alert.jsp").include(request,response);
            
            weatherAlertMail.SendMail(ListUser, "Hello," + "\n\n   The current weather issue in " +Region+ "\n    It's drizzling."
            + "\n\n    If you want to know more detail weather information, please visit our website \n\nThank you, \n\nWeather Now");
            
        }
       
        else if (Description.equals("moderate rain")) {
            session.setAttribute("Warning", "It's raining moderately.");
            request.getRequestDispatcher("alert.jsp").include(request,response);
            ...
            session.setAttribute("Warning", "There may be a sudden shower, so take your umbrella.");
            request.getRequestDispatcher("alert.jsp").include(request,response);
        ...
        else if (Description.equals("heavy intensity rain") || Description.equals("very heavy rain")) {
            session.setAttribute("Warning", "It's raining hard. Be careful when you go out!");
            request.getRequestDispatcher("alert.jsp").include(request,response);
        ...
        {
            session.setAttribute("Warning", "It's a cloudy day.");
            request.getRequestDispatcher("alert.jsp").include(request,response);
        }
        
        else if (Description.equals("overcast clouds")) 
        {
            session.setAttribute("Warning", "It's a cloudy day. Please take an umbrella with you in case it rains.");
            request.getRequestDispatcher("alert.jsp").include(request,response);
        ...
        else if (Description.equals("tunderstorm")) 
        {
            session.setAttribute("Warning", "There's thunder and lightning.");
            request.getRequestDispatcher("alert.jsp").include(request,response);
        ...
        {
            session.setAttribute("Warning", "It's snowing, so watch out for icy roads.");
            request.getRequestDispatcher("alert.jsp").include(request,response);
