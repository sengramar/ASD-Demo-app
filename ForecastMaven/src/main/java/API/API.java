...
public class API {
    ...
    static String DomainForecast = "http://api.openweathermap.org/data/2.5/forecast?q="; //Eunseo
    ...
    public static String getAPIWeatherForecastResult(String Location) { //Eunseo
        try {
